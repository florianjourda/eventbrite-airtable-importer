...
AIRTABLE_CONTACT_TABLE_ID = 'tbloEdq8Zw8GQ6l9R'
...
airtable_contacts = airtable_client.get(AIRTABLE_CONTACT_TABLE_ID).get('records')
...
for eventbrite_order in eventbrite_last_event_orders.get('attendees'):
  ...
  if airtable_ticket:
    ...
    if eventbrite_ticket_params != airtable_ticket_params:
      ...
      print('{} is up to date'.format(airtable_ticket_params.get('Order Id')))
  else:
